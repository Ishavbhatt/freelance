...
class Header extends React.Component {
  ...
  listenScrollEvent = e => {
    if (window.scrollY > 20) {
      this.setState({color: '#FF3A4C'})
      document.querySelector(".nav-links").className = "nav-links scroll-nav-links";
    } else {
      this.setState({color: 'transparent'})
      document.querySelector(".nav-links").className = "nav-links";
    }
  }
  ...
  render() {
    ...
    return (
      <>
        <div style={{"background-color": this.state.color}} className="header transition duration-1000 bg-transparent lg:px-10 py-5 md:px-10 px-5 fixed lg:py-2 w-full top-0 inset-x-0 z-50">
